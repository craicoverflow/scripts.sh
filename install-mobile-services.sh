...
export APP_NAMESPACE=${APP_NAMESPACE:-mobile-console}
...
kubectl create -n unifiedpush -f https://raw.githubusercontent.com/aerogear/unifiedpush-operator/master/deploy/service_account.yaml
kubectl create -f https://raw.githubusercontent.com/aerogear/unifiedpush-operator/master/deploy/role.yaml
kubectl create -n unifiedpush -f https://raw.githubusercontent.com/aerogear/unifiedpush-operator/master/deploy/role_binding.yaml
...
kubectl apply -n $NAMESPACE -f https://raw.githubusercontent.com/aerogear/unifiedpush-operator/master/deploy/crds/push_v1alpha1_unifiedpushserver_cr.yaml
...
kubectl create namespace $APP_NAMESPACE
kubectl create -f https://raw.githubusercontent.com/aerogear/mobile-security-service-operator/master/deploy/cluster_role.yaml
kubectl create -f https://raw.githubusercontent.com/aerogear/mobile-security-service-operator/master/deploy/cluster_role_binding.yaml
kubectl create -f https://raw.githubusercontent.com/aerogear/mobile-security-service-operator/master/deploy/service_account.yaml
